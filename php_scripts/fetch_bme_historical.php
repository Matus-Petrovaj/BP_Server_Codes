...
// Získanie údajov o teplote, vlhkosti a tlaku vzduchu z tabuľky `bme_table` pre zvolený časový rozsah
$sql = "SELECT temperature, humidity, pressure, timestamp FROM bme_table WHERE timestamp >= NOW() - $interval ORDER BY timestamp";
...
if ($result->num_rows > 0) {
    ...
    echo "No BME sensor historical data found.";
}
