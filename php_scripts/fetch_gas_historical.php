...
switch ($timeRange) {
    ...
    case '1w':
        ...
        break;
    default:
        $interval = 'INTERVAL 1 HOUR'; // Default nastaveny na 1 hodinu
        break;
}

// Získanie údajov o koncentrácii plynu z tabuľky `gas_table` pre zvolený časový rozsah
$sql = "SELECT ppm, timestamp FROM gas_table WHERE timestamp >= NOW() - $interval ORDER BY timestamp";
